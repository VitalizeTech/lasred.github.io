function JebBushWalker(game, spritesheet,  frameHeight, frameWidth, sheetWidth, x, y, frameDuration, frames, speed) {
...
JebBushWalker.prototype.update = function () {
    var isMoving = false;
    //find Trump Location
...
JebBushWalker.prototype.draw = function (ctx) {
