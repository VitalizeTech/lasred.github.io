function Gunman(game, spritesheet) {
    this.animation = new Animation(spritesheet, 150, 117, 7, 0.10, 28, true, -2);
    this.game = game;
    this.direction = 0;
    this.ctx = game.ctx;
    this.x = 100;
...
var gunmanDir = 5; 
Gunman.prototype.update = function () {
	var isMoving = true;
...
Gunman.prototype.draw = function (ctx) {
